...
{
	if (bios->bmp_offset) {
		return nv_bios_ro08(bios, bios->bmp_offset + 5) << 8 |
		       nv_bios_ro08(bios, bios->bmp_offset + 6);
	}
...
bmp_mem_init_table(struct nouveau_bios *bios)
{
	if (bmp_version(bios) >= 0x0300)
		return nv_bios_ro16(bios, bios->bmp_offset + 24);
	return 0x0000;
}
...
{
	if (bmp_version(bios) >= 0x0300)
		return nv_bios_ro16(bios, bios->bmp_offset + 26);
	return 0x0000;
}
...
{
	if (bmp_version(bios) >= 0x0300)
		return nv_bios_ro16(bios, bios->bmp_offset + 28);
	return 0x0000;
}
